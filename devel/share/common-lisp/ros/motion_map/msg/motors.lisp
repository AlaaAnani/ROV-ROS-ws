...
(cl:defmethod cl:initialize-instance :after ((m <motors>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motors)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motion_map-msg:<motors> is deprecated: use motion_map-msg:motors instead.")))

(cl:ensure-generic-function 'motorA-val :lambda-list '(m))
(cl:defmethod motorA-val ((m <motors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_map-msg:motorA-val is deprecated.  Use motion_map-msg:motorA instead.")
  (motorA m))

(cl:ensure-generic-function 'motorB-val :lambda-list '(m))
(cl:defmethod motorB-val ((m <motors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_map-msg:motorB-val is deprecated.  Use motion_map-msg:motorB instead.")
  (motorB m))

(cl:ensure-generic-function 'motorC-val :lambda-list '(m))
(cl:defmethod motorC-val ((m <motors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_map-msg:motorC-val is deprecated.  Use motion_map-msg:motorC instead.")
  (motorC m))

(cl:ensure-generic-function 'motorD-val :lambda-list '(m))
(cl:defmethod motorD-val ((m <motors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_map-msg:motorD-val is deprecated.  Use motion_map-msg:motorD instead.")
  (motorD m))

(cl:ensure-generic-function 'motorE-val :lambda-list '(m))
(cl:defmethod motorE-val ((m <motors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_map-msg:motorE-val is deprecated.  Use motion_map-msg:motorE instead.")
  (motorE m))

(cl:ensure-generic-function 'motorF-val :lambda-list '(m))
(cl:defmethod motorF-val ((m <motors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_map-msg:motorF-val is deprecated.  Use motion_map-msg:motorF instead.")
  (motorF m))

(cl:ensure-generic-function 'PH_button-val :lambda-list '(m))
(cl:defmethod PH_button-val ((m <motors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_map-msg:PH_button-val is deprecated.  Use motion_map-msg:PH_button instead.")
  (PH_button m))

(cl:ensure-generic-function 'TEMP_button-val :lambda-list '(m))
(cl:defmethod TEMP_button-val ((m <motors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_map-msg:TEMP_button-val is deprecated.  Use motion_map-msg:TEMP_button instead.")
  (TEMP_button m))

(cl:ensure-generic-function 'MAG_button-val :lambda-list '(m))
(cl:defmethod MAG_button-val ((m <motors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_map-msg:MAG_button-val is deprecated.  Use motion_map-msg:MAG_button instead.")
  (MAG_button m))

(cl:ensure-generic-function 'WATER_button-val :lambda-list '(m))
(cl:defmethod WATER_button-val ((m <motors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_map-msg:WATER_button-val is deprecated.  Use motion_map-msg:WATER_button instead.")
  (WATER_button m))
